...
if NOT "%IncludeSSLSrc%"=="false" set libraries=%libraries%     openssl-3.5.4
...
if NOT "%IncludeSSL%"=="false"     set binaries=%binaries% openssl-bin-3.5.4
if NOT "%IncludeTkinter%"=="false" set binaries=%binaries% tcltk-8.6.15.0-v145
